...
const MerchantAppPrivacyPolicy = () => {
  return (
<>
  <meta charSet="utf-8" />
  ...
  <p>
    EZYONE DIGITAL SYSTEMS PRIVATE LIMITED built the Eg Paid Merchant app as a
    Free app. This SERVICE is provided by EZYONE DIGITAL SYSTEMS PRIVATE LIMITED
  ...
  <p>
    ...
    and Conditions, which are accessible at Eg Paid Merchant unless otherwise
  ...
  <p>
    ...
    not limited to Subhojit Sadhukhan. The information that we request will be
  ...
  <p>This policy is effective as of 2023-07-20</p>{" "}
  <p>
    <strong>Contact Us</strong>
  </p>{" "}
  <p>
    If you have any questions or suggestions about our Privacy Policy, do not
    hesitate to contact us at care@egpaid.in.
  </p>{" "}
  <ul>
    <li>
      <a
        href="https://www.egpaid.in/privacy-policy.html"
        target="_blank"
        rel="noopener noreferrer"
      >
        More{" "}
